...
namespace Super.Core.Plugins.Payment
{
    ...
    public interface IPaymentPlugin:IPlugin
    {
        ...
        /// <returns></returns>
        PaymentInfo ProcessReturn(HttpRequest context);

        //PaymentInfo ProcessReturn(HttpRequestBase context, string pid, string privatekey);
        /// <summary>
        /// 处理异步通知结果
        /// </summary>
        ...
        /// <exception cref="ApplicationException"></exception>
        /// <returns></returns>
        PaymentInfo ProcessNotify(HttpRequest context);

        //PaymentInfo ProcessNotify(HttpRequestBase context,string pid, string privatekey);
        /// <summary>
        ...
        /// <param name="pid">支付宝pid</param>
        /// <param name="privatekey">支付宝私钥</param>
        /// <returns></returns>
        string GetRequestUrl(string returnUrl, string notifyUrl, string orderId, decimal totalFee, string productInfo, string pid,string  privatekey);
        /// <summary>
        /// 退款处理
        /// </summary>
        ...
        /// <exception cref="ApplicationException"></exception>
        /// <returns></returns>
        PaymentInfo ProcessRefundReturn(HttpRequest context);
        ...
        /// <exception cref="ApplicationException"></exception>
        /// <returns></returns>
        PaymentInfo ProcessRefundNotify(HttpRequest context);
        /// <summary>
        /// 企业付款
        /// </summary>
        ...
        /// <param name="para"></param>
        /// <returns></returns>
        EnterprisePayNotifyInfo ProcessEnterprisePayNotify(HttpRequest request);
        /// <summary>
        /// 网站插件列表Url
        /// </summary>
        ...
        /// 获取表单数据
        /// </summary>
        FormData GetFormData(string appid="");
        
        /// <summary>
        /// 设置表单数据
        /// </summary>
        /// <param name="values">表单数据键值对集合，键为表单项的name,值为用户填写的值</param>
        void SetFormValues(IEnumerable<KeyValuePair<string, string>> values,string appid="");
